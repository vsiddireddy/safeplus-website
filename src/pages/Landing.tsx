      ...
      */}
      ...
      <section className="bg-card pt-12 pb-24">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="relative mx-auto mt-12 w-[90%] overflow-hidden rounded-3xl bg-[#eef0f3] dark:bg-secondary sm:w-[80.4%]">
            <div className="grid items-center gap-4 md:grid-cols-[3fr_2fr]">
              <div className="px-8 pb-2 pt-10 sm:px-14 sm:py-12 md:py-24 md:px-14">
                <h3 className="text-center font-display text-2xl font-extrabold leading-tight tracking-tight text-foreground sm:text-left sm:text-3xl md:text-4xl">
          ...
          <div className="relative mx-auto mt-6 w-[90%] overflow-hidden rounded-3xl bg-[#eef0f3] dark:bg-secondary sm:w-[80.4%]">
            <div className="grid items-center gap-4 md:grid-cols-[2fr_3fr]">
              ...
              <div className="px-8 pt-36 pb-10 text-center sm:px-14 sm:py-12 md:py-24 md:px-14 sm:text-left">
          ...
          <div className="relative mx-auto mt-12 w-[90%] overflow-hidden rounded-3xl bg-[#eef0f3] dark:bg-secondary sm:w-[80.4%]">
            <div className="grid items-center gap-4 md:grid-cols-[2fr_3fr]">
              <div className="relative order-2 h-[400px] sm:h-[400px] md:order-1 md:h-[440px]">
                <img
                  src={isDark ? subLight : subDark}
                  alt="SafePlus subscriptions screen"
                  className="absolute left-1/2 top-0 w-[280px] max-w-none -translate-x-1/2 sm:top-4 sm:w-[340px] md:left-10 md:translate-x-0 md:w-[320px]"
                  loading="lazy"
                />
              </div>
      ...
      <section id="get-the-app" className="bg-card pb-24 scroll-mt-20">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mx-auto w-[96%] rounded-3xl bg-muted/60 p-8 sm:p-12 sm:w-[75%]">
            <div className="flex flex-col items-start justify-between gap-4 sm:gap-10 sm:flex-row sm:items-center">
