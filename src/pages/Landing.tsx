      ...
      */}
      ...
      <section id="features" className="bg-white py-24">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="relative mx-auto mt-12 w-[78.8%] overflow-hidden rounded-3xl bg-[#eef0f3]">
            <div className="grid items-center gap-4 md:grid-cols-2">
              ...
              <div className="relative h-[420px] sm:h-[480px] md:h-[560px]">
                <img
                  ...
                  className="absolute left-1/2 top-10 w-[280px] max-w-none -translate-x-1/2 sm:w-[340px] md:left-auto md:right-16 md:translate-x-0 md:w-[360px]"
                  loading="lazy"
                />
              </div>
            </div>
